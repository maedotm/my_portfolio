          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-full h-32 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center mb-4">
                  <div className="text-center">
                    <div className="text-slate-400 text-sm">Logo Space</div>
                    <div className="text-xs text-slate-500 mt-1">Upload your logo here</div>
                  </div>
                </div>
